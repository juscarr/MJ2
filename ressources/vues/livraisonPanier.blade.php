...
@section('contenu')
    ...
    <div class="section1" id="section1">
        ...
        <div class="rectangle">
            <div class="etape1" id="etape1_section1">Livraison</div>
            <div class="etape2" id="etape2_section1">Facturation</div>
            <div class="etape3" id="etape3_section1">Résumé</div>
        </div>
    ...
    <div class="section2" id="section2" style="display: none">
        ...
        <div class="rectangle">
            <div class="etape1" id="etape1_section2">Livraison</div>
            <div class="etape2" id="etape2_section2">Facturation</div>
            <div class="etape3" id="etape3_section2">Résumé</div>
        </div>
    ...
    <div class="section3" id="section3" style="display: none">
        ...
        <div class="rectangle">
            <div class="etape1" id="etape1_section3">Livraison</div>
            <div class="etape2" id="etape2_section3">Facturation</div>
            <div class="etape3" id="etape3_section3">Résumé</div>
        </div>
