...
=======
            ...
            <a href="index.php?controleur=panier&action=fiche"> <img class="panier" src="Shopping Cart.png" alt=""></a>
>>>>>>> MVC/CRUD-panier
            ...
            <header class="header">
                ...
                <nav>
                    <ul class="ul">
<<<<<<< HEAD
                        <li><a class="lien" href="index.php?controleur=compte&action=connexion">Se connecter</a></li>
                        <li><a class="lien" href="index.php?controleur=livre&action=index&page=1">Tous les livres</a></li>
=======
                        <li><a class="lien" href="#">Se connecter</a></li>
                        <li><a class="lien" href="index.php?controleur=livre&action=index&page=1">Tous les livres</a>
                        </li>
>>>>>>> MVC/CRUD-panier
